...
const commitContribution = function Contributions(prop) {
  ...
  return <div><div align="center"><h2>Commit</h2></div><DrawingPieBoard data={chart} /></div>
}
...
export default connect(mapStateToProps)(commitContribution)
