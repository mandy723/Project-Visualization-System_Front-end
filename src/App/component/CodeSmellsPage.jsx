...
function CodeSmellsPage(prop) {
  ...
  const [dataForCodeSmellChart, setDataForCodeSmellChart] = useState({
    labels: [],
    data: { codeSmell: [] },
  });
  ...
  return (
    <div style={{ marginLeft: "10px" }}>
      ...
      <h2>
        <a href={codeSmellUrl} target="blank">
          {
            dataForCodeSmellChart.data.codeSmell[
              dataForCodeSmellChart.data.codeSmell.length - 1
            ]
          }
        </a>
      </h2>
